...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                <h2 class="bg-white shadow mt-3 mb-4 text-center py-2 text-danger">Update Student Data</h2>
            </div>
            <div class="col-md-12">
                ...
                <form action="AllQuery.php" method="POST">
                    ...
                    ?>
                        ...
                        <input type="submit" value="Update Data" name="btnedit" class="btn btn-success">
                </form>
            </div>
        </div>
    </div>
